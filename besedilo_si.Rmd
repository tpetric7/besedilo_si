---
title: 'Scraping song lyrics from Besedilo.si (Search Function)'
...
```{r}
artist_name <- "Siddharta"
page_numbers <- 1:7
```

```{r}
artist_name <- "sank-rock"
page_numbers <- 1:23
```

```{r}
artist_name <- "Modrijani"
page_numbers <- 1:10
```

```{r}
artist_name <- "andrej-sifrer"
page_numbers <- 1:25
```

```{r}
artist_name <- "zoran-predin"
page_numbers <- 1:10
```

```{r}
artist_name <- "lacni-franz"
page_numbers <- 1:6
```

```{r}
artist_name <- "vlado-kreslin"
page_numbers <- 1:12
```

```{r}
artist_name <- "aleksander-mezek"
page_numbers <- 1:18
```

```{r}
artist_name <- "leteci-potepuhi"
page_numbers <- 1:1
```

```{r}
artist_name <- "ansambel-bratov-avsenik"
page_numbers <- 1:68
```
...
```{r}
url <- paste0("https://www.besedilo.si/", "page/", 
              page_numbers[1], "?s=", artist_name)
...
```{r}
base_url <- "https://www.besedilo.si/"
paging_urls <- paste0(base_url, "page/", page_numbers, 
                      "?s=", artist_name)
...
saveRDS(all_lyrics, 
           paste0("data/besedilo_si_",artist_name,"_",today,".rds"))
write.csv(all_lyrics, 
           paste0("data/besedilo_si_",artist_name,"_",today,".csv"))
write.csv2(all_lyrics, 
           paste0("data/besedilo_si_",artist_name,"_",today,
                  "_utf8",".csv"), fileEncoding = "UTF-8")
library(writexl)
write_xlsx(all_lyrics, 
           paste0("data/besedilo_si_",artist_name,"_",today,".xlsx"))
```
