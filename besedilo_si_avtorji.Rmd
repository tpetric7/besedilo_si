---
title: 'Scraping song lyrics from Besedilo.si (Author pages)'
...
```{r}
url <- paste0("https://www.besedilo.si/", "avtorji/", artist_name)
...
paging_urls <- paste0(base_url, "avtorji/", artist_name)
